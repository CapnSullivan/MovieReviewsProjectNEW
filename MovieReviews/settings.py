...
SECRET_KEY = 'django-insecure-t4y@axo1xj%e*4%has(vcj9r+u_=a!lupwco2@(d=wg_h=cr($'
...
#  Представляет путь к корневому каталогу, в котором хранятся ваши медиафайлы
MEDIA_ROOT = os.path.join(BASE_DIR, 'media/')

# Это URL-адрес, по которому будут обслуживаться ваши медиафайлы
MEDIA_URL = '/media/'
